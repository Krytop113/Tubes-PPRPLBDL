...
return new class extends Migration
{
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                IF p_id IS NULL OR p_id <= 0 THEN
                    ...
                    SET MESSAGE_TEXT = 'Gagal Hapus: ID order tidak valid.';

                ELSEIF NOT EXISTS (
                    SELECT 1 FROM orders WHERE id = p_id
                ) THEN
                    SIGNAL SQLSTATE '45000'
                    SET MESSAGE_TEXT = 'Gagal Hapus: Order dengan ID tersebut tidak ditemukan.';
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS delete_orders_procedure;');
    }
};