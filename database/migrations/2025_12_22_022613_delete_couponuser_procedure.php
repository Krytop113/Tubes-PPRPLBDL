...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            DROP PROCEDURE IF EXISTS delete_couponuser_procedure;

            CREATE PROCEDURE delete_couponuser_procedure(
                IN p_user_id BIGINT,
            ...
            BEGIN
                ...
                IF p_user_id IS NULL OR p_user_id <= 0 THEN
                    ...
                    SET MESSAGE_TEXT = 'Gagal Hapus: ID User tidak valid.';
                ...
                ELSEIF NOT EXISTS (
                    ...
                    SIGNAL SQLSTATE '45000'
                    SET MESSAGE_TEXT = 'Gagal Hapus: Relasi coupon dan user tidak ditemukan.';
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS delete_couponuser_procedure;');
    }
};