        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                IF p_id IS NULL OR p_id <= 0 THEN
                    ...
                    SET MESSAGE_TEXT = 'Gagal Hapus: ID Notifikasi tidak valid.';

                ELSEIF NOT EXISTS (SELECT 1 FROM notifications WHERE id = p_id) THEN
                    SIGNAL SQLSTATE '45000'
                    SET MESSAGE_TEXT = 'Gagal Hapus: Data notifikasi tidak ditemukan.';
