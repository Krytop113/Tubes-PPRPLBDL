                    ...
                    <form action="{{ route('updateProfile') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone_number" class="form-control bg-light border-start-0"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="date_of_birth" class="form-control bg-light border-start-0"
